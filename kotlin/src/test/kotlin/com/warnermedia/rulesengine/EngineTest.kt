...
internal class EngineTest {
    ...
    fun testSuccessfulResult() {
        ...
        assertEquals<ArrayList<RuleResult>>(arrayListOf(RuleResult.Success("good-weather", "good-weather-day")), result.ruleEvaluations)
    }

    @Test
    fun testFailureResult() {
        val result = engine.evaluate(hashMapOf("temperature" to 60, "rainfall" to 0))
        assertEquals<ArrayList<RuleResult>>(arrayListOf(RuleResult.Failure("good-weather", "work-from-home-day")), result.ruleEvaluations)
    }
